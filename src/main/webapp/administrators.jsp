...
<head>
    ...
    <link rel="stylesheet" href="css2/zy.all.css" />
            ...
            <div class="bd">
                <ul style="display: block;padding: 20px;">
                    <li>
                        <!--分页显示角色信息 start-->
                        <div id="dv1">
                            <form action="administrators.do" method="post" id="tijiao">
                                用户名：<input type="text" name="name" value="${name}">
                                <input type="submit" value="搜索" id="checkUser" onclick="checkUser()">
...
<c:forEach items="${pageInfo.list}" var="list">
                                <tr>
                                    ...
                                    <td>${list.level}</td>
                                    <td>${list.sex}</td>
                                    <td class="edit"><button onclick="btn_edit(1)"><i class="icon-edit bigger-120"></i>升级</button></td>
...
<tr>
    <td colspan="7">
        ...
        <a href="javascript:void(0)" onclick="page_nav(1)">首页</a>
        <a href="javascript:void(0)" onclick="page_nav(${pageInfo.prePage})">上一页</a>
        <a href="javascript:void(0)" onclick="page_nav(${pageInfo.nextPage})">下一页</a>
        <a href="javascript:void(0)" onclick="page_nav(${pageInfo.pages})">末页</a>
        ${pageInfo.pageNum}/${pageInfo.pages}
            ...
            <!--tab end-->
                    ...
                    <script src="js/user/Jqueryplugs.js" type="text/javascript"></script>
                    <script src="js/user/_layout.js"></script>
                    <script src="js/user/jquery.SuperSlide.source.js"></script>
                    <script>
                        var num = 1;
                        $(function() {
